 ...
 * * * *
 ...
 n=5: triangular number: 15
   ...
   * * * *
  * * * * *
Your task is to implement a function triangular_range(start, stop) that returns a dictionary of all numbers as keys and
the belonging triangular numbers as values, where the triangular number is in the range start, stop (including start and stop). For example, triangular_range(1, 3) should return {1: 1, 2: 3} and triangular_range(5, 16) should return {3: 6, 4: 10, 5: 15}.
"""
